...
SKIP = {
    ...
    "sql/stripe_derived/charge_events/view.sql",
    "sql/stripe_derived/charges_v1/init.sql",
    "sql/stripe_derived/charges_v1/query.sql",
    "sql/stripe_derived/plan_events/view.sql",
    "sql/stripe_derived/plans_v1/init.sql",
    "sql/stripe_derived/plans_v1/query.sql",
    "sql/stripe_derived/product_events/view.sql",
    "sql/stripe_derived/products_v1/init.sql",
    "sql/stripe_derived/products_v1/query.sql",
    "sql/stripe_derived/subscription_events/view.sql",
    "sql/stripe_derived/subscriptions_v1/init.sql",
    "sql/stripe_derived/subscriptions_v1/query.sql",
